    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-6 font-sans">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white">Sign In to CampusFix AI</h1>
          <p className="text-xs text-slate-400">Access your portal using official account credentials</p>
        </div>
        ...
        <button
          ...
          className="w-full bg-slate-950 hover:bg-slate-800/80 text-white border border-slate-700 font-medium text-xs py-2.5 rounded-lg transition flex items-center justify-center gap-2"
        >
        ...
        <div className="border-t border-slate-800 pt-4 text-center space-y-2 text-xs text-slate-400">
          ...
          <div>
            ...
            <Link to="/universities/register" className="text-sky-400 hover:underline">
              Register University
            </Link>
          </div>
        </div>
